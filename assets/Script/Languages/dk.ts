export const DK = {
    ...
    TranslatorName: "Marcus Moerk",
    Language: "Sprog",
    ThisLanguage: "Engelsk",
    OK: "OK",
    SteelMill: "Stålværk",
    StainlessSteelPlant: "Rustfrit Stålværk",
    CircuitFoundry: "Circuit Foundry",
    IntegratedCircuit: "Integrated Circuit",
    OilWell: "Oile Brønd",
    Wood: "Træ",
    LoggingCamp: "træfældning lejre",
    LumberMill: "Savværk",
    Lumber: "Tømmer",
    Paper: "Papir",
    PaperMill: "Papirfabrik",
    Book: "Bog",
    BookPublisher: "Bogtrykkeri",
    ...
    Buildings: "bygninger",
    Iron: "Jern",
    FuelType: "Vælg Brændstof",
    FuelCost: "Brændstofpris",
    FuelEconomy: "brændstoføkonomi",
    FuelInStorage: "%{fuel} På lager",
    Plastic: "Plastik",
    Petrol: "Benzin",
    Buy: "Køb",
    Multiplier: "Multiplier",
    MultiplierDesc: "Every 10 level, you get +1 multiplier",
    SellBuilding: "Sælg Bygning",
    ...
    Colosseum: "Colosseum",
    WindTurbine: "Vindmølle",
    Engine: "Motor",
    EngineFactory: "Motor Fabrik",
    CameraFactory: "Kamera Fabrik",
    Camera: "Kamera",
    Gun: "Våben",
    GunFactory: "Våben Fabrik",
    Aircraft: "Aircraft",
    ...
    Copper: "kobber",
    Gas: "Natur gas",
    GasPump: "Natur gas pumpe",
    GasPowerPlant: "Gas Power Plant",
    Missile: "Missil",
    MissileFactory: "Missil Fabrik ",
    Rocket: "Raket",
    RocketFactory: "Raket Fabrik",
    ...
    CopperMine: "kobber Mine",
    SiliconMine: "Silikone Mine",
    IronMine: "Jern Mine",
    CoalMine: "Kul Mine",
    Headquarter: "Hovedkvater",
    ...
    To: "Til",
    TransportTime: "Transport Tid",
    Warehouse: "Varehus",
    TradeWarehouse: "Freight Warehouse",
    Coal: "Kul",
    Video: "Video",
    ClothingFactory: "Tøj Fabrik",
    Clothes: "Tøj",
    Fashion: "Fashion",
    ...
    Music: "Musik",
    Glass: "Glas",
    PhoneFactory: "Telefon Fabrik",
    Phone: "Telefon",
    GlassFactory: "Glasfabrik",
    Oil: "Oile",
    Chromium: "Chromium",
    ...
    Console: "Konsol",
    ConsoleFactory: "konsol Fabrik",
    Train: "Tog",
    TrainFactory: "Tog Fabrik",
