export const DE = {
    ...
    ColorThemeDesc: "Farbschema für Spielsymbole, Hervorhebungen, Gitter und Hintergrund. ERFORDERT EINEN NEUSTART",
    ...
    ResourceBoosterBannerDescV2:
        "💡 Du hast aktuell %{number} Ressourcenverstärker - die benötigten Wissenschaftspunkte jedes einzelnen wird auf die Anzahl der Ressourcenverstärker skaliert, die du derzeit benutzt",
    ...
    FontSizeScalingDesc:
        "Verändert die Schriftgröße. Die Benutzeroberfläche könnte komisch aussehen. Benötigt einen Neustart.",
