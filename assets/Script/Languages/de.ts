export const DE = {
    ...
    GreenPeacekeeperDesc:
        "Produziere Heer, Marine, Lufwaffe oder Space Force nur mit erneuerbaren Energien (Wind/Solar)",
    ...
    LeaderboardOptOutDescV2:
        "Du wirst nicht mehr in der Bestenliste angezeigt und der Spielerhandel wird deaktiviert. BEMERKE: Wenn du wieder auf der Bestenliste stehen willst, muss dein Spiel zurückgesetzt werden",
    ...
    RequireExpansionPack2Desc: "Das ist nur mit der Erweiterung 2 verfügbar",
    Reindeer: "Rentier",
    ...
    ClearMyTrades: "Handel zurückziehen",
    SaveVersionTooNew:
    ...
    Dam: "Staudamm",
    DamDesc: "Staudämme verwandeln leere, angrenzende Zellen zu Wasserzellen",
    Farmland: "Acker",
    ...
    WaterEntityLevelTooHighDesc:
        "Das Gebäudelevel ist höher als das des anliegenden Staudammes. Verbessere zuerst deinen Staudamm.",
    ...
    BatteryFuelDesc:
        "💡 Nachdem Batterien als Kraftstoff verwendet wurden werden diese zu Batteriegehäusen. Du kannst Batterierecykler bauen, um sie zu recyceln oder wieder aufzuladen",
    ...
    PerthBonus:
        "<li>Building spinners rotate clockwise, which is opposite to other cities</li><li>Einzigartiges Ressourcenvorkommen: Geothermiequelle</li><li>Einzigartiges Gebäude: Hochenthalpie-Lagerstätten</li><li>Einzigartige Richtlinie: Adjacent Explorer (FREE), Factory Mining (FREE)</li>",
    ...
    SteamAutoCloudBackupDescV3:
        "Dein Fortschritt wurde in der Steamcloud gespeichert. Das Spiel speichert eigenständig alle 10 Minuten - du kannst jederzeit auch manuell speichern. Nach dem Laden eines Spielstandes verlierst du deine Handelsrechte und erhälst sie erst nach einer Wartezeit zurück.",
