export const EN = {
    ...
    OK: "OK",
    SteelMill: "Stålverk",
    StainlessSteelPlant: "Rustfrittstålverk",
    CircuitFoundry: "Kretsstøperi",
    IntegratedCircuit: "Integrert Krets",
    OilWell: "Oljebrønn",
    Wood: "Ved",
    LoggingCamp: "Skogbruk",
    LumberMill: "Sagbruk",
    Lumber: "Tømmer",
    Paper: "papir",
    PaperMill: "papirmølle",
    Book: "Bok",
    BookPublisher: "Bokforlag",
    OilRefinery: "Oljeraffinery",
    Sell: "Selg",
    Upgrade: "Oppgrader",
    Build: "Bygg",
    Buildings: "Bygninger",
    Iron: "Jern",
    FuelType: "Velg Drivstoff",
    FuelCost: "Drivstoffkostnader",
    FuelEconomy: "Drivstofføkonomi",
    FuelInStorage: "%{fuel} Lagret",
    Plastic: "Plast",
    Petrol: "Bensin",
    Buy: "kjøp",
    Multiplier: "Multiplikator",
    MultiplierDesc: "Hvert 10. nivå får du én ekstra muliplikator",
    SellBuilding: "Sell Bygning",
    PowerGrid: "Strømnett",
    SortBy: "Sorter etter",
    SortByPrice: "Pris",
    SortByAmount: "Antall",
    NotEnoughResources: "Ikke nok ressurser for denne operasjonen",
    Transportation: "Transport",
    Cash: "Penger",
    Aluminum: "Aluminium",
    ResearchPoint: "Forskningspoeng",
    Unlock: "Låse opp",
    BuildingUnlocked: "%{building} har blitt låst opp",
    Science: "Forskning",
    ScienceFromPowerDesc: "Kraftverk produserer en liten mengde forskningspoeng når de genererer kraft",
    Culture: "Kultur",
    School: "Skole",
    University: "Universitet",
    Polytechnic: "Polyteknisk høyskole",
    Colosseum: "Colosseum",
    WindTurbine: "Vindturbin",
    Engine: "Motor",
    EngineFactory: "Motorfabrikk",
    CameraFactory: "Kamerafabrikk",
    Camera: "kamera",
    Gun: "Pistol",
    GunFactory: "Pistolfabrikk",
    Aircraft: "Fly",
    AircraftFactory: "Flyfabrikk",
    Zeppelin: "Zeppelin",
    ZeppelinFactory: "Zeppelinfabrikk",
    Tank: "Tank",
    TankFactory: "Tankfabrikk",
    CoalPowerPlant: "Kullkraftverk",
    PetrolPowerPlant: "Diselkraftverk",
    Copper: "Kobber",
    Gas: "Naturgass",
    GasPump: "Naturgasspumpe",
    GasPowerPlant: "Gasskraftverk",
    Missile: "Missil",
    MissileFactory: "Missilfabrikk",
    Rocket: "Rakett",
    RocketFactory: "Rakettfabrikk",
    BuildingPermit: "Byggetillatelse",
    BuildingPermitDesc:
        "Du har tillatelser for %{amount} bygninger, du har allerede bygget %{amountBuilt} og har %{amountLeft} igjen",
    BuildingLocked: "Bygningen er ikke tilgjengelig ennå, du må låse den opp i forskningslabben først.",
    MaxBuilders: "Maks Byggere",
    MaxBuildersDesc: "Antall bygninger du kan bygge samtidig",
    Silicon: "Silisium",
    AluminumMine: "Aluminiumgruve",
    CopperMine: "Kobbergruve",
    SiliconMine: "Silisiumgruve",
    IronMine: "Jerngruve",
    CoalMine: "Kullgurve",
    Headquarter: "Hovedkvarter",
    ResearchLab: "Forskningslaboratorium",
    TradeCenter: "handelssenter",
    Resources: "Ressurser",
    NotEnoughCash: "Ikke nok penger til denne operasjonen",
    NotEnoughSwissMoney: "Ikke nok sveitsiske penger for denne operasjonen",
    BuildingNotEnoughFuel: "💡 Ikke nok %{fuel}",
    AutoSell: "Autoselg",
    Change: "Endre",
    StatisticsBureau: "Statistikkbyrået",
    LogisticsDepartment: "Logistikkavdeling",
    From: "Fra",
    Top20FuelCost: "Top 20 drivstoffkostnader",
    To: "Til",
    TransportTime: "Transporttid",
    Warehouse: "Lager",
    TradeWarehouse: "Fraktlager",
    Coal: "Kull",
    Video: "Video",
    ClothingFactory: "Klesfabrikk",
    Clothes: "Klær",
    Fashion: "Mote",
    FashionFactory: "Motefabrikk",
    VideoFarm: "Video Farm",
    SantaFactory: "Nissefabrikk",
    Santa: "Nisse",
    Car: "Bil",
    CarFactory: "Bilfabrikk",
    Ship: "Skip",
    SolarPanel: "Solcellepanel",
    SolarPanelDesc: "💡 Solcellepaneler fungerer bare fem sekunder av hvert tiende sekund - alle sykluser er justert",
    WindTurbineDesc: "💡 Vindturbiner fungerer bare åtte sekunder av hvert tiende sekund - sykluser er ikke justert",
    Movie: "Film",
    MovieStudio: "Filmstudio",
    Sitcom: "Sitcom",
    TVStudio: "TVstudio",
    PC: "PC",
    GameStudio: "Spillstudio",
    Game: "Spill",
    ComputerFactory: "Datafabrikk",
    Shipyard: "Verft",
    PowerUsage: "Strømforbruk",
    PowerSupply: "Strømforsyning",
    Level: "Nivå",
    Power: "Strøm",
    CentralBank: "Sentralbank",
    ResourceInput: "Inn",
    ResourceOutput: "Ut",
    ResourceStorage: "Lagring",
    ResourceChange: "Endring",
