export const IT = {
    ...
    GameControllerCameraSensitivityDesc: "Usa il joystick sinistro per spostare la telecamera - questo controllo ne aggiustà la sensibilità",
    GameControllerCursorSensitivity: "Sensibilità cursore con controller",
    GameControllerCursorSensitivityDesc: "usa il joystick destro per muovere il cursore - questo controllo ne aggiustà la sensibilita",
    GameControllerScrollSensitivity: "Sensibilità scroll/zoom con controller",
    GameControllerScrollSensitivityDesc: "Usa il trigger destro e sinistro per scrollare o aumentare/siminuire lo zoom - questo controllo ne aggiusta la sensibilità",
