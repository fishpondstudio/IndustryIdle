export const RU = {
    ...
    BatchOperationGainResult:
        "Результат групповой операции: успешно: %{success}, неудачно: %{fail}, всего получено: $%{gain}",
    ...
    GameControllerCameraSensitivityDesc: "Используйте левый джойстик для перемещения камеры - это настраивает ее чувствительность",
    GameControllerCursorSensitivity: "Чувствительность геймпада для курсора",
    GameControllerCursorSensitivityDesc: "Используйте правый джойстик для перемещения курсора - это настраивает его чувствительность",
    GameControllerScrollSensitivity: "Чувствительность геймпада для прокрутки/масштабирования",
    GameControllerScrollSensitivityDesc: "Используйте левый или правый триггер для прокрутки или масштабирования - это настраивает их чувствительность",
