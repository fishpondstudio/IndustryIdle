export const RU = {
    ...
    AchievementCrowdfundingTycoon: "Краудфандинговый магнат",
    AchievementCrowdfundingTycoonDesc: "Заложите ресурсы на сумму 1Qa в рамках одного краудфандинга",
    ...
    FarmlandOfflineFarmingDesc:
        "Фермы, построенные на естественных водных источниках, продолжают выработку продукции даже когда вы в оффлайне. Подпадают под ограничения на продолжительность оффлайн-заработка, а также под влияние усовершенствований Индустриальных кредитов",
    ...
    NextWaveSpeed: "Скороть передвижения",
    ...
    AccountLimitedActionV2: "Прочитать FAQ о ограниченном аккаунте",
