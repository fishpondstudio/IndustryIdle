export const EN = {
    ...
    GameSettingHotkeyTip4: "When navigating through menus, the [Escape] key can be used to travel to the page leading to the current page.",
    GameSettingHotkeyTip5: "The [Home] key can be used to pan the camera from wherever it's current location is back to your HQ.",
