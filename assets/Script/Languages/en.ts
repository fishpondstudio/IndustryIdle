export const EN = {
    ...
    ClearTradesTitle1: "⛔ You Should NOT Pass ⛔",
    ClearTradesDescription1: "This is NOT a claim function.  All active trades will be DELETED.  No cash ot item refunds!",
    ClearTradesNo1: "Cancel",
    ClearTradesYes1: "Confirm",
    ClearTradesTitle2: "⛔⛔⛔ Final Chance To Cancel ⛔⛔⛔",
    ClearTradesDescription2: "Deleting trades will delete all cash and items associated.  There is no undo.  Only proceed if you are absolutely certain.",
    ClearTradesNo2: "Cancel",
    ClearTradesYes2: "Delete ☣ Trades",
};
