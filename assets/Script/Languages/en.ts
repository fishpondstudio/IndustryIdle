export const EN = {
    ...
    GameSettingSFXClickDesc: "Volume control for the sound effect that can be heard when you clicking on different things.",
    GameSettingSFXCompleted: "Trade Filled",
    GameSettingSFXCompletedDesc: "The sound effect that can be heard when you receive a new claimable trade via the player market.",
    GameSettingSFXFreeChest: "Claim Offline Earnings",
    GameSettingSFXFreeChestDesc: "Volume control for the initial sound effect that can be heard when claiming offline earnings.",
    GameSettingSFXGold: "Coin Clink",
    GameSettingSFXGoldDesc: "Volume control for the sound effect of coins clinking that can be heard near the end of the claim offline earnings animation.",
    GameSettingSFXError: "Error",
    GameSettingSFXErrorDesc: "Volume control for the sound effect that can be heard when you when you attempt an action that cannot be completed or if an error as occurred.",
    GameSettingSFXKaching: "Ka-ching",
    GameSettingSFXKachingDesc: "Volume control for the sound effect that can be heard in a wide variety of contexts. Most commonly when claiming profits from CrowdFunding, Player Trade and the Wholesale Center.",
    ...
    GameSettingHotkey: "Hotkey Configuration",
    GameSettingHotkeyTip1: "As of the current build, only alphabet keys and the Ctrl, Shift and Alt modifier keys are supported for custom definitions.",
    GameSettingHotkeyTip2: "If a UI Panel features a sub-menu; you can use numeric keys [1-9] to navigate through each sub-menu entry.",
    GameSettingHotkeyTip3: "Certain key combinations are reserved by your browser and or operating system; [Ctrl+N], [Ctrl+Shift+N], [Ctrl+T], [Ctrl+W], [Ctrl+Shift+W]",
    GameSettingHotkeyTip4: "When navigating through menus, the [Escape] key can be used to travel 'backwards' to the page leading to your current page.",
    GameSettingHotkeyTip5: "The [Home] key can be used to smoothly pan the camera from it's current location to centered over your HQ.",
