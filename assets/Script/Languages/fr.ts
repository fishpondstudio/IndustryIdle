export const FR = {
    ...
    StreamingStopStream: "Arréter la diffusion pour ce spectateur",
    ...
    BatteryFuelDesc:
        "💡 Après usage comme fuel, les Batteries deviennent des Batteries Vides. Vous pouvez construire un Recycleur de Batterie pour les recycler ou les recharger",
