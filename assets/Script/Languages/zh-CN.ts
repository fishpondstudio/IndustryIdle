export const ZH_CN = {
    ...
    NextTutorial: "下一步",
    Tutorial1:
        "闲置工业(IndustryIdle)是一款<em>资源管理</em>建造游戏🏭。在这里你可以建立工厂，生产商品📦并获得金钱💸。<br><br>让我们通过一些基本的概念介绍帮助你开始 - 我保证这不会花很长时间。",
    Tutorial2:
    ...
    SaveAndExit: "保存并退出游戏",
    SaveAndExitDesc:
        "保存并退出游戏。此功能只在steam版本游戏内可用，且与直接点击窗口栏的关闭按钮作用相同。（没有什么用）",
    ...
    PlayerTradeCancelDescV2: "该贸易已支付的税款将不予退还",
    ...
    ExternalManageYourSaveDesc: "由于技术限制，您必须从游戏官方网站导入和导出您的保存数据。",
    MREPlant: "即食植物餐",
    PlayerTradeTaxCreditProduction: "税收减免:生产",
    PlayerTradeTaxCreditProductionDescV2:
        "该减税额度基于 %{res} 自上次市场更新以来，你们生产了哪些产品：您已经生产了 %{produced} 而你的交易 %{used}",
    ...
    GameSettingGeneral: "基本",
    GameSettingDisplay: "显示",
    GameSettingHideElements: "从视图隐藏",
    GameSettingAudio: "声音",
    ...
    GameSettingSFXVolumeOverride: "音效音量覆盖",
    ...
    PlayerTradePendingFineDesc:
        "您已经将 $%{profit} 从 %{count} 与作弊玩家进行交易 %{player}. 您需要返还利润后才能再次交易",
