export const ZH_CN = {
	...
	StockRatingDesc:
		"来自华尔街分析师的股票评级共识，它会影响你的市值，并随市场一起随机更新",
	OfflineEarning: "离线收益",
	PerMin: "%{amount}/分钟",
	...
	AdjacentBonusOnlyOutputDesc:
		"相邻的加成不需要更多的投入，但是会消耗更多的电力，并且只有原来50%的效果",
	...
	FPS30Desc:
		"打开节能模式将使游戏以30FPS而非60FPS运行。这将延长您的电池续航时间",
	...
	ProductionMultiplierDesc:
		"提高您所有建筑物的生产能力（包括矿场，工厂，发电厂，科学和文化建筑物）",
	...
	PrestigeAlertContent:
		"您的公司将被清算。您将以 %{amount} 瑞士货币兑现并润到 %{city} 在那成立新公司",
	PrestigeCurrencyDesc:
		"这是您在秘密瑞士银行帐户的钱，您可以带上它走在一个新的城市重新开始",
	Prestige: "现金已到位😎",
	Cancel: "取消",
	...
	CrowdfundingAlreadyPledgedDesc:
		"你可以认捐更多资源，这将提高你的总认捐金额（和潜在回报），但不会计入众筹目标",
	...
	IndustryZoneNotWorkingDesc:
		"工业园的所有相邻建筑物应形成供应链，不超过%{level}级，且不是其他工业园的一部分",
	...
	SwissUpgradeDesc:
		"这个瑞士货币升级是永久性的。如果你在一个新城市开始，此项升级将会保留",
	SwissBoost: "瑞士加成（临时）",
	SwissBoostDesc:
		"瑞士加成只会影响您当前这一局游戏。如果你在一个新城市开始，此项升级将被重置",
	...
	HighSpeedWarehouseDesc:
		"仓库的运输总容量是原来的2倍，运输的速度提高了50%，但使用的电力是原来的2倍",
	...
	IndustryZoneBuildingPermitDesc:
		"如果一个工业园内有N层生产链，它将免费提供N-2个建筑许可证",
	...
	ReturnOnPledgeDescV2:
		"您的总回报等于总认捐价值乘以(1 + 所有资源的回报率)。更多的捐助者将会提高其回报率",
	...
	FactoryMining: "工厂采矿",
	FactoryMiningDesc:
		"工厂可以直接在矿床地块上采矿，前提是工厂消耗与该地块相同的矿产资源（免费政策）",
	...
	FarmlandOfflineFarmingDesc:
		"建立在自然水上的农田可以在你离线时生产。离线盈利受离线时间和瑞士货币升级影响",
	...
	StandbyMode: "待机模式",
	StandbyModeDesc:
		"游戏将继续在后台运行，但不会渲染任何图形。这将显著地减少GPU的使用，并适度减少CPU的使用",
	...
	BatchOperationGainResult:
		"批量操作结果：成功： %{success}, 失败: %{fail}, 总收入： $%{gain}",
	...
	BatteryFuelDesc:
		"💡 电池作为燃料燃尽后将变成电池壳。你可以建造电池回收站以回收电池或给电池充电",
	FriedChicken: "炸鸡",
	Coffee: "咖啡",
	Cocoa: "可可豆",
	CornSyrup: "液态糖",
	...
	FontSizeScalingDesc:
		"修改用户界面字体大小比例。需要重启生效⚠️有些元素可能会变得看起来不合适",
	...
	KansasCityHydroDamBoost:
		"堪萨斯城独特加成：这个水坝为相邻的农田提供 %{boost} 加成",
	...
	PathTemporarilyBlocked:
		"你不能在这个地块上建造，因为入侵正在进行中。请在这一波结束后重试",
	MoveBuilding: "移动建筑",
	...
	PanelHeight: "面板高度",
	PanelHeightDesc:
		"选择面板的高度。只在移动设备上的竖屏模式下工作（需要重新加载）",
	...
	ElectricFishPondDesc:
		"每个正在运行的水力发电厂为地图上的所有鱼塘提供 20% 的容量提升",
	...
	HydroFarming: "水坝",
	HydroFarmingDesc:
		"每个工作中的水坝为地图上的所有农田和温室提供 20% 的容量提升",
	...
	OnlyShowPositiveModifiersHint:
		"点击建筑名称左侧的复选框以在地图上显示地块修正",
	ClearMyTradesV2: "清空我的交易",
	OpenSource: "做贡献",
	OpenSourceDesc:
		"Industry Idle 现在开源了。你可以在 Github 上为游戏开发做贡献",
	GameGuides: "游戏向导",
	GameSetting: "设置",
