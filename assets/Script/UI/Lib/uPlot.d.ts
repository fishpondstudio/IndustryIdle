...
declare namespace uPlot {
    ...
    export type PaddingSide =
        | number
        | null
        | ((self: uPlot, side: Axis.Side, sidesWithAxes: SidesWithAxes, cycleNum: number) => number);
    ...
    export namespace Legend {
        ...
        export type Stroke =
            ...
            | ((self: uPlot, seriesIdx: number) => CSSStyleDeclaration["borderColor"]);

        export type Dash =
            | CSSStyleDeclaration["borderStyle"]
            | ((self: uPlot, seriesIdx: number) => CSSStyleDeclaration["borderStyle"]);
    ...
    export namespace Cursor {
        ...
        export namespace Points {
            ...
            export type Stroke =
                ...
                | ((self: uPlot, seriesIdx: number) => CanvasRenderingContext2D["strokeStyle"]);
            export type Fill =
    ...
    export namespace Scale {
        ...
        export type Clamp =
            | number
            | ((self: uPlot, val: number, scaleMin: number, scaleMax: number, scaleKey: string) => number);
    }
    ...
    export namespace Series {
        ...
        export namespace Points {
            ...
            export type Show =
                | boolean
                | ((self: uPlot, seriesIdx: number, idx0: number, idx1: number) => boolean | undefined);

            export type Filter =
                | number[]
                | null
                | ((self: uPlot, seriesIdx: number, show: boolean, gaps?: null | number[][]) => number[] | null);
        ...
        export type GapsRefiner =
            | Gaps
            | ((self: uPlot, seriesIdx: number, idx0: number, idx1: number, nullGaps: Gaps) => Gaps);
        ...
        export type Value =
            | string
            | ((self: uPlot, rawValue: number, seriesIdx: number, idx: number) => string | number);
    ...
    export namespace Axis {
        ...
        export type Space =
            | number
            | ((self: uPlot, axisIdx: number, scaleMin: number, scaleMax: number, plotDim: number) => number);
        ...
        export type Stroke =
            | CanvasRenderingContext2D["strokeStyle"]
            | ((self: uPlot, axisIdx: number) => CanvasRenderingContext2D["strokeStyle"]);
        ...
        export type Rotate =
            | number
            | ((self: uPlot, values: (string | number)[], axisIdx: number, foundSpace: number) => number);
